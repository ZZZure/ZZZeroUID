    ...
    if all_char_data:
        for char in all_char_data:
            ...
            if char_data:
                ...
                if "PartnerInfo" in char_data and "FullName" in char_data["PartnerInfo"]:
                ...
                if char not in ["2011", "2021"]:
                    partner_data[char].update(
                        {
                            "WeaponType": list(char_data["WeaponType"].keys())[0],
                            "ElementType": list(char_data["ElementType"].keys())[0],
        ...
        for weapon in all_weapon_data:
            ...
            if weapon_data:
                weapon_result[weapon] = {
                    ...
                    "props_id": PROP_NAME_TO_ID[weapon_data["BaseProperty"]["Name2"]],
                    "props_value": weapon_data["BaseProperty"]["Value"],
                    "rand_props_name": weapon_data["RandProperty"]["Name"],
                    "rand_props_id": PROP_NAME_TO_ID[weapon_data["RandProperty"]["Name2"]],
