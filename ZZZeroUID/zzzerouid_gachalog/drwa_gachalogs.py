...
async def draw_card():
    ...
    up_tag = '运气一般'
    # TODO TAG列表绘制
    card_img_draw.text((397, 555), str(up_gacha_cur), red_color, zzz_font_26, 'mm')
    card_img_draw.text((255, 630), str(up_gacha_avg_s), whole_white_color, zzz_font_38, 'mm')
    card_img_draw.text((370, 630), str(up_gacha_avg_up), whole_white_color, zzz_font_38, 'mm')
    card_img_draw.text((490, 630), str(up_gacha_total), whole_white_color, zzz_font_38, 'mm')
    card_img_draw.text((730, 670), up_tag, whole_white_color, zzz_font_38, 'mm')
    ...
    card_img_draw.text((397, 1155), str(wp_gacha_cur), red_color, zzz_font_26, 'mm')
    card_img_draw.text((255, 1230), str(wp_gacha_avg_s), whole_white_color, zzz_font_38, 'mm')
    card_img_draw.text((370, 1230), str(wp_gacha_avg_up), whole_white_color, zzz_font_38, 'mm')
    card_img_draw.text((490, 1230), str(wp_gacha_total), whole_white_color, zzz_font_38, 'mm')
    card_img_draw.text((730, 1270), wp_tag, whole_white_color, zzz_font_38, 'mm')
    ...
    card_img_draw.text((397, 1155), str(nm_gacha_cur), red_color, zzz_font_26, 'mm')
    card_img_draw.text((255, 1230), str(nm_gacha_avg_s), whole_white_color, zzz_font_38, 'mm')
    card_img_draw.text((370, 1230), str(nm_gacha_avg_up), whole_white_color, zzz_font_38, 'mm')
    card_img_draw.text((490, 1230), str(nm_gacha_total), whole_white_color, zzz_font_38, 'mm')
    card_img_draw.text((730, 1270), nm_tag, whole_white_color, zzz_font_38, 'mm')

    card_img.save('test.png')

asyncio.run(draw_card())
